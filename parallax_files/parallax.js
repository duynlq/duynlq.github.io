$(function () {
    ...
    controls.shape.copy(shape.collection[0].data);
...
var Canvas = mClass(function () {
    ...
    return {
        construct: function (container) {
            ...
            this.pixelWidth = canvasElement.first.width = 544;
            this.pixelHeight = canvasElement.first.height = 300;
    ...
    return {
        construct: function (canvas) {
            ...
            this.collection = [
                ...
                {name: "Create Your Own (Click Anywhere Above!) ", data: []}
