...
Our final project for the Statistical Foundations course in the
Southern Methodist University Master of Science of Data Science program was to challenge us to predict
the final price of each home in Ames, Iowa from 2006 to 2010, making regression analyses using what we have learned in the course.
...
$$log(SalePrice) = β0 + β1log(GrLivArea) + β2Edwards + $$
$$β3NAmes + β4Edwards*log(GrLivArea) + β5NAmes*log(GrLivArea)$$
